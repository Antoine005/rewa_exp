function Read_me
%
% Check that you have copy and paste subjects' reward Schedule in
% reward_schedule folder. 
% You can get reward Schedule from second session.
%
% "inputs" foledr : the parameters for session 1 (pre-test session)
% "data"   folder : outcomes from the experiments
%
% In the input fodler, there are 16 subjects' mat files, each file is 9*1
% structures. 
%
% ------------------------------------------------------------------------
...
% sv                : the value starts to decrease from begin of trial
...
% startValue        : value for each trial
