function run_SAT_ColorPenalty(subID,blockNo)
%
...
for trialNo=1:nTrialsPB
    ...
    sampleRate = inputs(blockNo).sampleRate(1,1);
    ...
    fprintf(fid,'%i\t %i\t %i\t %i\t %i\t %.4f\t %i\t %i\t %i\t %i\n',...
        blockNo,trialNo,sampleRate,buttonPress,chooseR,RT,win,total_sum,correct,chooseLeft);
